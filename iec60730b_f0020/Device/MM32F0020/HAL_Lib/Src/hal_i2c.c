...
void I2C_Init(I2C_TypeDef* i2c, I2C_InitTypeDef* init_struct)
{
    ...
    MODIFY_REG(i2c->CR, (I2C_CR_EMPINT |
                         I2C_CR_SLAVEDIS |
                         I2C_CR_REPEN |
                         I2C_CR_MASTER10 |
                         I2C_CR_SLAVE10 |
                         I2C_CR_SPEED |
                         I2C_CR_MASTER), ((0x01U << I2C_CR_EMPINT_Pos) |
                                         ((init_struct->I2C_Mode ==
                                           I2C_Mode_MASTER) ? (0x01U << I2C_CR_SLAVEDIS_Pos) : (0x00U << I2C_CR_SLAVEDIS_Pos)) |
                                         (0x01U << I2C_CR_REPEN_Pos) |
                                         ((init_struct->I2C_ClockSpeed <= 100000) ? I2C_CR_STD : I2C_CR_FAST) |
                                           init_struct->I2C_Mode));
