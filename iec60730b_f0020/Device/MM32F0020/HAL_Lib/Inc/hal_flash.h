...
#define EraseTimeout                    ((u32)0x00002FFF)                       ///< new Flash page/sector erase request 6ms, Mass erase 40ms
#define ProgramTimeout                  ((u32)0x0000012F)                       ///< new Flash half word program request 155us
