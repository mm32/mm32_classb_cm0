...
//#define SYSCLK_FREQ_XXMHz   HSE_VALUE     //HSE_VALUE is define in reg_common.h
//#define SYSCLK_FREQ_XXMHz   24000000      //24000000 based HSE_VALUE
//#define SYSCLK_FREQ_XXMHz   36000000      //36000000 based HSE_VALUE
//#define SYSCLK_FREQ_XXMHz   48000000      //48000000 based HSE_VALUE
...
static void SetSysClockToXX(void)
{
    ...
    do {
        ...
        StartUpCounter++;
    } while((HSEStatus == 0) && (StartUpCounter != (10 * HSE_STARTUP_TIMEOUT)));
    ...
    if (HSEStatus == (u32)0x01) {
        //PLL SYSCLK, HCLK and PCLK1 configuration ---------------------------
