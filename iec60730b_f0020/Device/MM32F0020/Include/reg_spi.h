...
#define I2S_CFGR_I2SSTD_Philips         (0x00U << I2S_CFGR_I2SSTD_Pos)          ///<  I2S selection Philips standard
#define I2S_CFGR_I2SSTD_MSB_L           (0x01U << I2S_CFGR_I2SSTD_Pos)          ///<  I2S selection Left aligned (MSB) standard
#define I2S_CFGR_I2SSTD_MSB_R           (0x02U << I2S_CFGR_I2SSTD_Pos)          ///<  I2S selection Right alignment (MSB) standard
#define I2S_CFGR_I2SSTD_PCM             (0x03U << I2S_CFGR_I2SSTD_Pos)          ///<  I2S selection PCM standard
