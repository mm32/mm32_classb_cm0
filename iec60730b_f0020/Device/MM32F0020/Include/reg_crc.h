...
#define CRC_CR_BITSEL_0                 (0x00U << CRC_CR_BITSEL_Pos)             ///< Input bit width selection 32 bit
#define CRC_CR_BITSEL_1                 (0x01U << CRC_CR_BITSEL_Pos)             ///< Input bit width selection 16 bit
#define CRC_CR_BITSEL_2                 (0x02U << CRC_CR_BITSEL_Pos)             ///< Input bit width selection  8 bit
