...
// MM32 Library version is @version@
...
// MM32 Library release date is @date@ (YYYY-MM-DD)
#define __MM32_LIB_RELESE_YEARH         (0x00U)                                 //!< [31:24] release year high 
#define __MM32_LIB_RELESE_YEARL         (0x00U)                                 //!< [23:16] release year low
#define __MM32_LIB_RELESE_MONTH         (0x00U)                                 //!< [15:8]  release month
#define __MM32_LIB_RELESE_DAY           (0x00U)                                 //!< [7:0]   release day
