...
typedef enum {
    ...
    COMP_InvertingInput_IO5             = COMP_CSR_INM_5,                       ///< INM5 as COMP inverting input
    COMP_InvertingInput_IO6             = COMP_CSR_INM_6,                       ///< INM6 as COMP inverting input
    COMP_InvertingInput_IO7             = COMP_CSR_INM_7,                       ///< INM7 as COMP inverting input
    COMP_InvertingInput_CRV             = COMP_CSR_INM_4,                       ///< INM4 as COMP inverting input
    COMP_InvertingInput_VSSA5           = COMP_CSR_INM_5,                       ///< INM5 as COMP inverting input
    COMP_InvertingInput_VSSA6           = COMP_CSR_INM_6,                       ///< INM6 as COMP inverting input
    COMP_InvertingInput_VSSA7           = COMP_CSR_INM_7,                       ///< INM7 as COMP inverting input
...
#define   COMP1_CSR_INM0_PA5            COMP_CSR_INM_0
#define   COMP1_CSR_INM1_PA6            COMP_CSR_INM_1
#define   COMP1_CSR_INM2_PA7            COMP_CSR_INM_2
#define   COMP1_CSR_INM3_PD6            COMP_CSR_INM_3
#define   COMP1_CSR_INM3_CRV            COMP_CSR_INM_4
#define   COMP1_CSR_INM4_VSSA5          COMP_CSR_INM_5
#define   COMP1_CSR_INM4_VSSA6          COMP_CSR_INM_6
#define   COMP1_CSR_INM4_VSSA7          COMP_CSR_INM_7

#define   COMP1_CSR_INP0_PA1            COMP_CSR_INP_INP0
#define   COMP1_CSR_INP1_PA2            COMP_CSR_INP_INP1
#define   COMP1_CSR_INP2_PA3            COMP_CSR_INP_INP2
#define   COMP1_CSR_INP3_PA4            COMP_CSR_INP_INP3
