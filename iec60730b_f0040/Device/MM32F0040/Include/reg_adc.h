...
typedef struct {
    ...
    __IO u32 RESERVED0x94;                                                      ///<                                                offset 0x94
    __IO u32 RESERVED0x98;                                                      ///<                                                offset 0x98
    __IO u32 RESERVED0x9C;                                                      ///<                                                offset 0x9C
    __IO u32 RESERVED0xA0;                                                      ///<                                                offset 0xA0
    __IO u32 RESERVED0xA4;                                                      ///<                                                offset 0xA4
    __IO u32 RESERVED0xA8;                                                      ///<                                                offset 0xA8
    __IO u32 RESERVED0xAC;                                                      ///<                                                offset 0xAC
