...
#define COMP_CSR_INM_4                  (0x04U << COMP_CSR_INM_Pos)             ///< INM4_CRV as COMP inverting input
#define COMP_CSR_INM_5                  (0x05U << COMP_CSR_INM_Pos)             ///< INM5_VSSA as COMP inverting input
#define COMP_CSR_INM_6                  (0x06U << COMP_CSR_INM_Pos)             ///< INM6_VSSA as COMP inverting input
#define COMP_CSR_INM_7                  (0x07U << COMP_CSR_INM_Pos)             ///< INM7_VSSA as COMP inverting input
