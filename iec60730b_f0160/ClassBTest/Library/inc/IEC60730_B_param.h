...
/* uncoment next lines to select clock selftest method */
#define USE_TIM2_CLOCK_CHECK
//#define USE_IWDG_CLOCK_CHECK
...
#endif /* HSE_VALUE */
#define SYSTCLK_AT_STARTUP      (uint32_t)(96000000uL)
#define SYSTCLK_AT_RUN_HSI      (uint32_t)(96000000uL)
#define SYSTCLK_AT_RUN_HSE      (uint32_t)(96000000uL)
...
#define LSI_Min               8000u // LSI - 80%
#define LSI_Max              72000u // LSI + 80%
...
#define LSI_INCAP            1u // Clock self-check using HSI(or HSE) and LSI, TIM2_CH4 = LSI
//#define HSI_INCAP            2u // Clock self-check using HSE and HSI, TIM2_CH4 = HSI/4
//#define HSE_INCAP            3u // Clock self-check using HSI and HSE, TIM2_CH4 = HSE/128
...
#define MCU_RAM_End_ADDR               (0x20003FFFUL)
